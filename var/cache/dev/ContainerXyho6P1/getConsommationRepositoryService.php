 ...
 */
class getConsommationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\consommationRepository' shared autowired service.
     *
     * @return \App\Repository\consommationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'consommationRepository.php';

        return $container->privates['App\\Repository\\consommationRepository'] = new \App\Repository\consommationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
