 ...
 */
class getCollectdechetsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CollectdechetsRepository' shared autowired service.
     *
     * @return \App\Repository\CollectdechetsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CollectdechetsRepository.php';

        return $container->privates['App\\Repository\\CollectdechetsRepository'] = new \App\Repository\CollectdechetsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
